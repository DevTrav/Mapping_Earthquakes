...
d3.json(all_week).then(function(data) {
...
L.geoJSON(data, {
  ...
  // set the style for each circleMarker using styleInfo
style: styleInfo,
  // creates a popup for each circleMarker to display the magnitude and
...
// Crea†e a legend control object
